## Introduction - On Learning and Training
...
In the following part, we will focus mainly on the first aspect (preparation) and then give you guidance on how to plan and manage your course. To start with, we will speak about three theoretical issues which will provide you with an idea of what teaching and learning means; namely "learning theory”, "learning types” and how teaching adults differs from teaching teenagers or children. 
...
* Knowing Knowledge, George Siemens (2006) [http://www.elearnspace.org/KnowingKnowledge_LowRes.pdf](http://www.elearnspace.org/KnowingKnowledge_LowRes.pdf)
...
Recommended Read: "The Adult Learner", Malcolm *Knowles*, Elwood Holton & Richard Swanson, 7th ed 2011 for a deeper understanding of the matter.

### Learning styles

Learning Styles[ https://en.wikipedia.org/wiki/Learning_styles](https://en.wikipedia.org/wiki/Learning_styles) is a technique for categorising learners that deserves mentioning. It is based on distinguishing four different styles

1. Visual: students learn best from what they see.

2. Auditory: students learn by listening.

3. Communicative: students only learn when they can express themselves by reading or writing.

4. Kinesthetic (motoric): students learn by doing something with their hands or the whole body.

Generally it is said that each person is a combination of two or even more types. No matter if this is true or not you should always teach classes that combine auditory, visual, communicative and kinesthetic aspects. It is likely you will have a diverse combination of learning approaches present. Variety will help to make your class more entertaining or stimulating to trainees.  

You should especially have these learning types in mind whenever it comes to practical exercises and interaction. Remember, as the instructor you will prefer one or two of the learning styles, which might increase the risk of falling back to the same type of teaching or practical exercises again and again. 

Description of learning styles: [https://www.learning-styles-online.com/overview](https://www.learning-styles-online.com/overview/)[/](https://www.learning-styles-online.com/overview/) 

Illustration of the learning types: [https://blog.prezi.com/the-four-different-types-of-learners-and-what-they-mean-to-your-presentations-infographic](https://blog.prezi.com/the-four-different-types-of-learners-and-what-they-mean-to-your-presentations-infographic) 
...
*→ will be replaced by own image  CARTOON*
...
Adapted from "SMART Goals, How to create objective, measurable project goals" by Kristian Rother (available online from [http://www.academis.eu/posts/smart_goals](http://www.academis.eu/posts/smart_goals) )
...
[https://www.mindtools.com/pages/article/newLDR_76.htm](https://www.mindtools.com/pages/article/newLDR_76.htm)
...
Active Learning is a process whereby learners are actively engaged in the learning process, rather than "passively" absorbing lectures: for example, ???. Active learning involves reading, writing, discussion, and engagement in solving problems, analysis, synthesis, and evaluation. Active learning often involves cooperative learning with other attendees.
